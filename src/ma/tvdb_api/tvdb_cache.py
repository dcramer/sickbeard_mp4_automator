    ...
    def default_open(self, request):
        ...
        if exists_in_cache(self.cache_location, request.get_full_url(), self.max_age):
            return CachedResponse(
                self.cache_location, request.get_full_url(), set_cache_header=True
            )
        else:
            return None
...
class CachedResponse(StringIO.StringIO):
    ...
    def __init__(self, cache_location, url, set_cache_header=True):
        ...
        StringIO.StringIO.__init__(self, open(bpath, "rb").read())
    ...
    def recache(self):
        ...
        store_in_cache(self.cache_location, new_request.url, new_request)
        CachedResponse.__init__(self, self.cache_location, self.url, True)

    @locked_function
    def delete_cache(self):
        delete_from_cache(self.cache_location, self.url)
